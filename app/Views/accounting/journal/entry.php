...
<div class="row row-card mt-3 mx-1">
  <div class="col-12">
    <ul class="nav nav-tabs border-0">
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url('accounting/journal') ?>">Halaman Utama</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url('accounting/journal/data') ?>">Data Jurnal</a>
      </li>
      <li class="nav-item">
        <a class="nav-link active bg-white border-white" href="<?= base_url('accounting/journal/entry') ?>">Entri Jurnal</a>
      </li>
    </ul>
